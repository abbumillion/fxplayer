package com.app.fxplayer.views.components.audiovirtualizationview;
    ...
    public class PaintService extends AnimationTimer {
        ...
        public void handle(long nanos) {
            ...
            if (getWaveService().getResultingWaveform() == null || recalculateWaveData) {
                ...
                //Start the Service
                getWaveService().startService(getWaveService().getFile(), WaveFormService.WaveFormJob.WAVEFORM);
