package com.app.fxplayer.player.visualization.soundcloud;
...
public class WaveFormService extends Service<Boolean> {
     ...
     *
     */
    public void startService(File file , WaveFormJob waveFormJob) {
    ...
    protected Task<Boolean> createTask() {
        return new Task<Boolean>() {
            ...
            private float[] processAmplitudes(int[] sourcePcmData) {
                ...
                int width = (int) waveVisualization.getWidth();
